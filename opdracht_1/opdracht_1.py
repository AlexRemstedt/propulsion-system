...
# Figuur 1
ax1 = fig.add_subplot(20, 2, 1)  # fig.add_subplot(#rows, #cols, #plot)
...
fig.savefig('images/opdracht_1.svg')
fig.savefig('images/opdracht_1.png', bbox_inches='tight')
